...
const STRING_FIELDS = new Set([
  ...
  'account',
  'kind',
  // 官方增量被拒的上游错误体摘要（official.incremental_rejected）
  'detail',
  // 原生 MCP 门面审计（webpool_mcp.*）与自探：工具名/参数键名（无值）/拒绝原因/目录来源
  'tool',
  'args_keys',
  'reason',
  'spec_source',
...
const BOOLEAN_FIELDS = new Set([
  ...
  'dx_present',
  // 原生 MCP 门面审计/自探（webpool_mcp.call / webpool.native_selftest）
  'ok',
]);
